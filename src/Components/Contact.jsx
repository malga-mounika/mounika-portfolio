            ...
            <div className="mx-auto max-w-6xl px-6">
                ...
                >
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-400">
                        ...
                        collaborations, and interesting projects in AI/ML, Generative AI,
                    ...
                    <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                        ...
                        {/* Email */}
                        <a
                            href="mailto:mounikamalga9@gmail.com"
                            className="flex items-center gap-3 rounded-xl border border-slate-700 bg-slate-900/50 px-5 py-3 text-slate-300 transition hover:border-indigo-500 hover:text-indigo-400"
                        >
                            <Mail size={20} />
                            <span>mounikamalga9@gmail.com</span>
                        </a>
                    ...
                    <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex items-center gap-2 rounded-xl border border-slate-700 px-6 py-3 font-semibold text-slate-200 transition hover:border-indigo-500 hover:text-indigo-400"
                        >
                            <Github size={19} />
                            GitHub
                        </a>
